...
class Fy2017 extends CI_Controller
{
	...
	public function e01car()
	{
		...
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2017/photos/car/',ed.photo1) 'photo1'", FALSE);
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2017/photos/car/',ed.photo2) 'photo2'", FALSE);
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2017/photos/car/',ed.photo3) 'photo3'", FALSE);
...
//		$db->select("ea.zip '(公開)郵便番号', ea.prefecture '(公開)都道府県', ea.address1 '(公開)住所1', ea.address2 '(公開)住所2', ");
		...
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2017/photos/publicinfo/',ed.photo) '(公開)画像'", FALSE);
...
//		$result = mb_convert_kana($result, "KVsa", "UTF-8");
	...
	public function e03present()
	{
		...
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2017/photos/present/',ed.itemphoto) '商品画像'", FALSE);
