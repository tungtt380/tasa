...
class Clicccar extends PubOP_Controller {

	protected $form_prefix   = 'promo/clicccar';	// フォーム名
	...
	protected function get_record(&$data, $uid)
	{
		...
		$this->load->model('booth_model');
//		$data['booth'] = $this->booth_model->get_dropdown();
//		$data['boothgroup'] = $this->booth_model->get_dropdown(FALSE);
		// 2011.09.20 detailでS850等を見るためのパッチ
...
//          $text = $this->parser->parse('mail/promotion_regist_url_waiting.txt', $data, TRUE);
//      } else {
