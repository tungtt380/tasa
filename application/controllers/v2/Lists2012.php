...
class Lists2012 extends CI_Controller {
	...
	public function exhibitors($word='')
	{
        ...
        $this->load->dbutil();
		$db = $this->load->database('tasa2012', TRUE);
	...
	public function e01car()
	{
		...
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2012/photos/car/',ed.photo1) 'photo1'", FALSE);
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2012/photos/car/',ed.photo2) 'photo2'", FALSE);
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2012/photos/car/',ed.photo3) 'photo3'", FALSE);
...
//      $result = mb_convert_kana($result, "KVsa", "UTF-8");
	...
	public function e02publicinfo()
	{
		...
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2012/photos/publicinfo/',ed.photo) '(公開)画像'", FALSE);
...
//      $result = mb_convert_kana($result, "KVsa", "UTF-8");
	...
	public function e03present()
	{
		...
		$db->select("CONCAT('http://archive.tokyoautosalon.jp/2012/photos/present/',ed.itemphoto) '商品画像'", FALSE);
