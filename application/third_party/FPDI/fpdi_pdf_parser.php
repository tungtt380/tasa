...
class fpdi_pdf_parser extends pdf_parser {
     ...
     */
    // Upgrade PHP7 - Silence “Methods with the same name as their class will not be constructors in a future version of PHP” error in PHP 7 - Start by TTM
    // function fpdi_pdf_parser($filename, &$fpdi) {
    function __construct($filename, &$fpdi) {
    // Upgrade PHP7 - Silence “Methods with the same name as their class will not be constructors in a future version of PHP” error in PHP 7 - End by TTM
        $this->fpdi =& $fpdi;
