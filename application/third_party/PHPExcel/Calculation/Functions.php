...
class PHPExcel_Calculation_Functions {
	...
	public static function TYPE($value = NULL) {
		...
		if (($value === NULL) || (is_float($value)) || (is_int($value))) {
				...
				return 64;
				// Upgrade PHP7 - Silence “ 'break' not in the 'loop' or 'switch'” error in PHP 7 - Start by TTM
				//break;
				// Upgrade PHP7 - Silence “ 'break' not in the 'loop' or 'switch'” error in PHP 7 - End by TTM
