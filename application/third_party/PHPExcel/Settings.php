...
class PHPExcel_Settings
{
	...
	// Upgrade CI3 - Rename to the correct class, from ZipArchive to PHPExcel_Shared_ZipArchive - Start by TTM
	// const ZIPARCHIVE	= 'ZipArchive';
	const ZIPARCHIVE	= 'PHPExcel_Shared_ZipArchive';
	// Upgrade CI3 - Rename to the correct class, from ZipArchive to PHPExcel_Shared_ZipArchive - End by TTM
